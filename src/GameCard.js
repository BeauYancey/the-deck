function GameCard({gameObj}) {
  ...
  return (
    <div className="card">
      <img src={gameObj.imgSrc} className="card-img-top"/>
      <div className="card-body">
        <h5 className="card-title">{gameObj.GAME}</h5>
        ...
        <div className='card-buttons'>
          ...
          <div style={{display: 'flex', justifyContent: 'space-around'}}>
            ...
            <button className="btn btn-outline-secondary"><img height="25px" src="https://cdn-icons-png.flaticon.com/512/2702/2702134.png" title="instructions" /></button>
